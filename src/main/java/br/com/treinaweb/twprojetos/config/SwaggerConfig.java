...
public class SwaggerConfig {
    ...
    private static final String CONTATO_EMAIL = "kenzleydev@outlook.com";
    private static final String CONTATO_URL = "https://www.linkedin.com/in/luankenzley123/";
    private static final String CONTATO_NOME = "Luan Kenzley";
    ...
    public Docket getDocket() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage(PACOTE_BASE)).paths(PathSelectors.any())
                .build()
